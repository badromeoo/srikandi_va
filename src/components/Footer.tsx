        ...
        <div className="grid md:grid-cols-2 gap-8">
          ...
          <div className="flex flex-col items-center justify-center text-center md:items-end md:justify-between">
            ...
            <Image
              ...
              className="h-auto w-[180px] sm:w-[250px] order-first md:order-last"
            ...
            <Link
              href="/request"
              className="mt-8 md:mt-0 w-full md:w-auto inline-flex h-12 items-center justify-center rounded-md bg-[#A11692] px-8 text-base font-medium text-white shadow transition-colors hover:bg-[#A11692]/90"
            >
              Hubungi kami
            </Link>
          </div>
